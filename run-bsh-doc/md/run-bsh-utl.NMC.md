...
> Auto-generated on 2026-04-30 14:11:25
...
private nda-edw-utl project tree. Wired into every Confluence
publish action so nda-edw-utl content can NEVER reach the
Alchemists Confluence space.

nda-edw-utl is personal automation / consulting tooling; it is
...
**File:** `run-bsh-utl/src/bash/run/replicate-dir-from-src-proj.func.sh`
...
**File:** `run-bsh-utl/src/bash/run/replicate-dir-to-tgt-proj.func.sh`
...
**File:** `run-bsh-utl/src/bash/run/replicate-file-from-src-proj.func.sh`
...
**File:** `run-bsh-utl/src/bash/run/replicate-file-to-tgt-proj.func.sh`
...
**File:** `run-bsh-utl/src/bash/run/replicate-git-changes.func.sh`

*⚠ Legacy format — no structured metadata available.*

---

### `do_replicate_proj_from_bas`

**File:** `run-bsh-utl/src/bash/run/replicate-proj-from-bas.func.sh`
...
**File:** `run-bsh-utl/src/bash/run/replicate-proj-from-src-proj.func.sh`
...
**File:** `run-bsh-utl/src/bash/run/replicate-proj-to-tgt-proj.func.sh`
