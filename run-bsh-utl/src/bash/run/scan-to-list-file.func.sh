#!/bin/bash
#------------------------------------------------------------------------------
# @description Scans the project directory and generates an inclusion list
# @description file (.include.lst) for packaging, respecting exclusion patterns.
# @param MODULE (optional) - The name of the module (defaults to $PROJ).
# @example ./run -a do_scan_to_list_file
#------------------------------------------------------------------------------
